# KPR Calculator — Agent Context

Shared context for any coding agent working in this repo (Claude Code, Codex,
or others) — `CLAUDE.md` is a symlink to this file, so there is one source of
